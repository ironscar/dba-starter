...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:0ZdIGMe1LcczDbGktnzKAw==$ejfHiiiyyS8sG4Mlcu0FrFYytYH9Uo8AEhRXMkt9hgE=:0LnDcwCbXjocv1CbnPct26u2yN3gc+zc4RXeb2fI9R4=';
CREATE ROLE springstudent;
ALTER ROLE springstudent WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:kdknxRA9uc7JVpZ84RTLJw==$34omtzVLOOk8i3EaL/utNH55oVigwfGyc0GDAbTI7Lg=:NQEcX5egyp5JHyPXMP+9oX8odtDYYnsFQu9ykhLhSuI=';
...
1	Iron	Scar	ironscar@gmail.com
\.
...
REVOKE ALL ON SEQUENCE public.student_id_seq FROM postgres;
